                                    ...
                                    <tbody className="divide-y divide-gray-200 bg-white">
                                        {/* {data.map((user) => ( */}
                                            <tr>
                                                ...
                                                <td className="whitespace-nowrap px-4 py-4 text-sm text-gray-700">
                                                    <button type="button" onClick={()=>{acceptdata()}} className="rounded-md bg-green-600 mx-4 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-600/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Accept</button>
