            ...
            <div className="mx-auto h-[100%] flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
                ...
                <div className="hidden lg:block">
                    <ul className="inline-flex space-x-8">
                        {menuItems.map((item) => (
                            <li key={item.name}><Link to={item.to} className="text-lg font-semibold hover:text-accent hover:border-b-4 border-accent rounded">{item.name}</Link></li>
                        ))}
                    </ul>
                </div>
                ...
                <div className="hidden lg:block">
                    <Link to='/admin/addcourse'>
                        <button type="button" className="text-primary bg-bgColor rounded-md mr-4 px-2 py-1 text-lg font-semibold shadow-sm hover:bg-[] hover:text-textPrimary hover:bg-accent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">Add Course</button>
                    </Link>
                    <button type="button" onClick={handleLogout} className="text-textPrimary bg-accent rounded-md ml-4 px-2 py-1 text-lg font-semibold shadow-sm hover:bg-white/100 hover:text-primary hover:bg-bgColor focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">Log out</button>
                </div>
                    ...
                    <div className="absolute inset-x-0 top-0 z-50 origin-top-right transform p-2 transition lg:hidden">
                        <div className="divide-y-2 divide-gray-50 rounded-lg bg-bgColor shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="px-5 pb-6 pt-5">
                                ...
                                <Link to='/admin/addcourse'>
                                    <button type="button" className="mt-4 w-full rounded-md bg-accent text-textPrimary px-3 py-2 text-sm font-semibold shadow-sm hover:bg-secondry hover:text-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">Add Notes</button>
                                </Link>
