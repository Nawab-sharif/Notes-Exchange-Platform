...
const Work = () => {
    ...
    // })
    return (
        <div className='work h-[100vh] max-w-[100%] bg-bgColor flex items-center'>
            <div className="left h-[100%] w-[50%] flex items-center justify-center">
                <img src={work} alt="work image" className='h-[70%] w-[90%]' />
            </div>
            <div className="right text-textPrimary h-[60%] w-[40%] grid grid-cols-2">
                ...
                <div className="box flex flex-col items-center justify-center">
                    <span className='text-accent text-[4rem] flex'>
                        ...
                        <h2 className='value text-[2rem] my-[15%] text-textPrimary font-bold'>1258+</h2>
                    </span>
                ...
                <div className="box flex flex-col items-center justify-center">
                    <span className='text-accent text-[4rem] flex'>
                        ...
                        <h2 className='text-[2rem] my-[15%] text-textPrimary font-bold'>150+</h2>
                    </span>
                ...
                <div className="box flex flex-col items-center justify-center">
                    <span className='text-accent text-[4rem] flex'>
                        ...
                        <h2 className='text-[2rem] my-[15%] text-textPrimary font-bold'>1255+</h2>
                    </span>
                ...
                <div className="box flex flex-col items-center justify-center">
                    <span className='text-accent text-[4rem] flex'>
                        ...
                        <h2 className='text-[2rem] my-[15%] text-textPrimary font-bold'>1157+</h2>
                    </span>
